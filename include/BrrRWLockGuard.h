...
public: // methods
    //! ********************************************************************************************
    //! @brief Lock pRWLock for write (call WriteLock), if pRWLock is NULL print error and do
    //! nothing, if lock failed then print error.
    //! ********************************************************************************************
    WriteLockGuard(RWLock* pRWLock);

    //! ********************************************************************************************
    //! @brief Lock pRWLock for write (call WriteLock), if pRWLock is NULL  print error and do
    //! nothing, if lock failed then print error with c_className.
    //! ********************************************************************************************
    WriteLockGuard(RWLock* pRWLock, const std::string& c_className);

    //! ********************************************************************************************
    //! @brief Unlock pRWLock (call Unlock), if pRWLock is NULL print error and do nothing, if lock
    //! failed then print error and c_className if exist.
    //! ********************************************************************************************
    ~WriteLockGuard();
...
public: // methods
    ...
    //! if lock failed then print error.
    //! ********************************************************************************************
    ReadLockGuard(RWLock* pRWLock);

    //! ********************************************************************************************
    //! @brief Lock pRWLock for read (call ReadLock), if pRWLock is NULL print error and do nothing,
    //! if lock failed then print error with c_className.
    //! ********************************************************************************************
    ...
    //! if lock failed then print error and c_className if exist.
    //! ********************************************************************************************
    ~ReadLockGuard();
